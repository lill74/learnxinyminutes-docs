...
translators:
    - ["Yi Soul", "https://github.com/lill74"]
    - ["wikibook", "http://wikibook.co.kr"]
filename: learnpython-ko.py
lang: ko-kr
---

Python은 귀도 반 로섬이 90년대에 만들었습니다. Python은 현존하는 널리 사용되는 언어 중 하나입니다. 저는 문법적 명료함에 반해 Python을 사랑하게 됐습니다. Python은 기본적으로 실행 가능한 의사코드입니다.

이 글은 Python 3 에만 적용됩니다. 구 버전 Python 2.7 을 배우고 싶다면 [here](http://learnxinyminutes.com/docs/pythonlegacy/) 을 확인해주세요.
